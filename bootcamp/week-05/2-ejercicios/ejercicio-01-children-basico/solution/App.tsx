      ...
      <Section paddingY="lg">
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '32px' }}>
          ...
          <Card>
            ...
            <p style={{ margin: 0 }}>El children puede ser cualquier cosa.</p>
          </Card>
        </div>
        ...
        <div
          ...
          {showAlert && (
            <Alert
              ...
              Hubo un problema al procesar tu solicitud. Haz clic en × para
              cerrar.
            </Alert>
          )}
        </div>
        ...
        <div style={{ marginBottom: '32px' }}>
          <p>
            Texto normal con{' '}
            <MaybeLink href="https://react.dev">un enlace</MaybeLink> y{' '}
